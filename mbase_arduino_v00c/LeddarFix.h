...
//  { }
  ...
  Leddar16( unsigned long Baud, unsigned char Addr, SoftwareSerial& Port, unsigned char Pin = 0, unsigned char Action = 0) 
...
//  { }
  ...
  LeddarOne( unsigned long Baud, unsigned char Addr, SoftwareSerial& Port, unsigned char Pin = 0, unsigned char Action = 0) 
  : BaudRate(Baud), SlaveAddress(Addr), NbDet(0), TxEn_Pin(Pin), TxEn_Action(Action)  , SerialPort(Port)
  { }
...
//  { } 
  ...
  char parseResponse();
  void clearDetections();
  char setBaud(uint8_t baud_code);
